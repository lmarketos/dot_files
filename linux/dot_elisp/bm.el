...
(defface bm-face
  '((((class grayscale) 
    ...
    (((class color) 
      (background light)) (:foreground "White" :background "firebrick"))
    (((class color) 
      (background dark))  (:foreground "Black" :background "firebrick")))
...
(defface bm-persistent-face
  '((((class grayscale) 
    ...
    (((class color) 
      (background light)) (:foreground "White" :background "firebrick"))
    (((class color) 
      (background dark))  (:foreground "White" :background "firebrick")))
