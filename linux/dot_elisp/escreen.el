...
;;; $Id: escreen.el,v 1.1 2007/01/26 18:39:18 jeremy Exp $
...
(defvar escreen-map-data-format
  '((escreen-map-save-window-start    . escreen-map-restore-window-start)
    ...
    (escreen-map-save-tool-bar-mode   . escreen-map-restore-tool-bar-mode)
...
(defun escreen-map-save-tool-bar-mode ()
  (and (boundp 'tool-bar-mode)
       tool-bar-mode))

(defun escreen-map-restore-tool-bar-mode (v)
